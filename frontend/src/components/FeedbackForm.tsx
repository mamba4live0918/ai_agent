    ...
    return (
      <div className="card p-5 animate-in" style={{ animationDelay: '220ms' }}>
        <div className="text-center py-4">
          ...
          <p className="text-[var(--text-primary)] font-medium mb-1">感谢你的反馈！</p>
          <p className="text-xs text-[var(--text-secondary)] mb-3">你的评价将帮助我们持续改进</p>
          <button onClick={() => { setSubmitted(false); setRating(0); setText(''); }} className="text-xs text-[var(--accent-blue)] hover:underline">
            再次评价
          </button>
        </div>
      </div>
  ...
  return (
    <div className="card p-5 animate-in" style={{ animationDelay: '220ms' }}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">用户反馈</span>
        {stats && (
