      ...
      <div className="w-full max-w-sm">
        <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-lg font-semibold text-[#e6edf3]">创建账户</h1>
            <p className="text-xs text-[#8b949e] mt-1">注册 AI 销售助手</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-[#8b949e] mb-1.5">邮箱</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-xs text-[#8b949e] mb-1.5">确认密码</label>
              <input
                type="password"
