    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between mb-6 animate-in" style={{ animationDelay: '0ms' }}>
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-1">浏览和搜索销售辅助文档，支持 RAG 智能问答</p>
        </div>
                  ...
                  <tr key={doc.id}>
                    <td>
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-medium text-[var(--text-primary)] truncate max-w-[300px]">{doc.title}</span>
                      </div>
                    </td>
                    <td>
