...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-8 py-4 sm:py-10">
      ...
      {/* Module cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-5 sm:mb-8 animate-in" style={{ animationDelay: '150ms' }}>
      ...
      {/* Section cards */}
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 animate-in" style={{ animationDelay: '220ms' }}>
        {/* Training */}
