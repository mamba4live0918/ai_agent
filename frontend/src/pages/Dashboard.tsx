...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-8 py-4 sm:py-10">
      ...
      {/* Stats row */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-5 sm:mb-8 animate-in" style={{ animationDelay: '80ms' }}>
        <div className="card p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 hover:-translate-y-0.5">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-[var(--accent-blue)] font-mono tabular-nums">
            {loading ? '--' : docCount}
          </p>
          <p className="text-xs text-[var(--text-tertiary)] mt-0.5 sm:mt-1">已索引的销售辅助文档</p>
        </div>
        ...
        <div className="card p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 hover:-translate-y-0.5">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-[var(--accent-green)] font-mono tabular-nums">
            {loading ? '--' : customerCount}
          </p>
          <p className="text-xs text-[var(--text-tertiary)] mt-0.5 sm:mt-1">AI 画像分析的客户</p>
        </div>
        ...
        <div className="card p-4 sm:p-6 rounded-xl sm:rounded-2xl transition-all duration-200 hover:-translate-y-0.5">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-[var(--accent-orange)] font-mono tabular-nums">
            {loading ? '--' : productCount}
          </p>
          <p className="text-xs text-[var(--text-tertiary)] mt-0.5 sm:mt-1">基金/保险/信托/理财产品</p>
        </div>
      </div>

      {/* Module cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 animate-in" style={{ animationDelay: '150ms' }}>
